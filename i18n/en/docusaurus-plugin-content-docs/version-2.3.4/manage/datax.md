...
| Configuration     | Description                                                                                                                                                                                                                                                                       | Whether to select | Default Value                         |
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- | ------------------------------------- |
...
- Config specifies the time accuracy provided by the Reader plugin, default in milliseconds.Tenant: `cnosdb`

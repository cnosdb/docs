...
在CnosDB集群中数据迁移的基本单元是Vnode。The basic unit of data migration in a CnosDB cluster is Vnode. The enterprise edition of CnosDB cluster provides the following commands to support tiered storage:

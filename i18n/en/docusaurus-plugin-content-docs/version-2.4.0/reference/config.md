...
| `raft_logs_to_keep`       | `5000`      | The number of entries left in the Raft log and write to snapshot every time these are checked.                                                                                                                                                                                                                                                 |
...
| `sync_interval`                 | `0`                   | Synchronize WAL interval without active sync in：`h`, `m`, `s`, `ms`, `us`, `ns` |
...
| `partition`            | Equivalent CPU quantity | number of partitions to memcache cache, default value equals CPU quantity |
...
| 参数                         | Default | Description                                                                                                             |
| -------------------------- | ------- | ----------------------------------------------------------------------------------------------------------------------- |
| `report_time_interval_sec` | `30`    | Time interval between reporting heart, disk balance and other information on this node to the `meta` service, unit：`s`. |
...
| 参数                       | Default                             | Description                                                         |
| ------------------------ | ----------------------------------- | ------------------------------------------------------------------- |
| `jaeger_agent_endpoint`  | `http://localhost:14268/api/traces` | The Jaeger agent endpoint.e.g.：http\://localhost:14268/api/traces   |

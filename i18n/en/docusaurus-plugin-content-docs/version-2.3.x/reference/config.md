...
| `sync_interval`                 | `0`                   | Time interval for synchronizing the WAL, i.e. without active synchronization, in h, m, s, ms, us, ns |
...
| `partition`            | Equal to the number of system 'CPU' | Number of partitions for memcache cache           |
